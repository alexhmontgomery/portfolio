    ...
    return (
      <div>
        ...
        <div className='card-group'>
          <div className='card'>
            <img className='card-img-top' src='https://images-na.ssl-images-amazon.com/images/M/MV5BMTYwMTA4MzgyNF5BMl5BanBnXkFtZTgwMjEyMjE0MDE@._V1_UX182_CR0,0,182,268_AL_.jpg' alt='dallas-buyers' />
          ...
          <div className='card'>
            <img className='card-img-top' src='https://images-na.ssl-images-amazon.com/images/M/MV5BMTU2MzcyODgyNV5BMl5BanBnXkFtZTcwNTc4MDYwOQ@@._V1_UX182_CR0,0,182,268_AL_.jpg' alt='mud' />
            <div className='card-block'>
          ...
          <div className='card'>
            <img className='card-img-top' src='https://images-na.ssl-images-amazon.com/images/M/MV5BMTQ4NDE4NTY5MV5BMl5BanBnXkFtZTcwODQyMTkxNA@@._V1_UX182_CR0,0,182,268_AL_.jpg' alt='lincoln-lawyer' />
            <div className='card-block'>
          ...
          <div className='card'>
            <img className='card-img-top' src='https://images-na.ssl-images-amazon.com/images/M/MV5BYjBhNjc1NjktZTg4OS00YmUyLWI4YjAtNGIxZGM4ZTdkNmZkXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_UX182_CR0,0,182,268_AL_.jpg' alt='ed-tv' />
            <div className='card-block'>
